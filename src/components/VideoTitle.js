    ...
    <div className="w-screen aspect-video pt-[20%] px-6 md:px-24 absolute text-white bg-gradient-to-r from-black">
      ...
      <div className="flex my-2 md:my-0">
        {/* <img
          ...
          alt="play-button"
        /> */}
        <button className="bg-white text-black py-1 md:py-4 px-10 md:px-16 w-10 text-xl rounded-lg hover:bg-opacity-80">
          Play
        </button>
        <button className="hidden md:inline-block mx-2 bg-gray-500 text-white p-4  px-16 w-10 text-lg bg-opacity-50 rounded-lg">
          More Info
        </button>
      </div>
    </div>
