    ...
    <div className="w-screen aspect-video pt-[20%] px-6 md:px-24 absolute text-white bg-gradient-to-r from-black">
      ...
      <div className="flex my-2 md:my-0">
        {/* <img
          ...
          alt="play-button"
        /> */}
        <button className="bg-white text-black py-1 md:py-4 px-10 md:px-16  text-xl rounded-lg hover:bg-opacity-80">
          <div className="flex">
            <div>
              <FaPlay />{" "}
            </div>
            <div className="-my-1 mx-1">Play</div>
          </div>
        </button>
        <button className="hidden md:inline-block mx-2 bg-gray-500 text-white p-4  px-16 text-lg bg-opacity-50 rounded-lg">
          <div className="flex">
            <div>
              <FaInfoCircle />{" "}
            </div>
            <div className="-my-1 mx-1">More Info</div>
          </div>
        </button>
      </div>
    </div>
